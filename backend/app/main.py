...
from app.routers import ai, calculators, contact, currency_converter, decision, exchange, health, mortgage_refinance_router, user, whatif
...
app.include_router(currency_converter.router, prefix=settings.api_v1_prefix)
